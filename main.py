...
if __name__ == "__main__":
    ...
    for idx in range(180,183+1):
        print("softstep_bottleneck_cifar10/{}_o1_cifar-100-python".format(idx))
        trainer = EvalTrainer(
            CIFAR10, "log/softstep_bottleneck_cifar10/{}_o1_cifar-100-python.json".format(idx), device="cuda:1")
        trainer.train()
