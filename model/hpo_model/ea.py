...
class EAPolicy():
    def __init__(self, search_space: str, observe, algorithm="GA") -> None:
        ...
        if self.tag == "pso":
            return
            self.controller = PSO(func=self.schaffer, n_dim=44, pop=4, max_iter=50, lb=[1]*44, ub=[32.99, 64.99, 3.99, 32.99, 192.99, 3.99, 32.99, 192.99, 3.99, 192.99, 3.99, 192.99, 3.99, 64.99, 384.99, 3.99,
                                  384.99, 3.99, 384.99, 3.99, 96.99, 576.99, 3.99, 576.99, 3.99, 576.99, 3.99, 128.99, 768.99, 3.99, 768.99, 3.99, 768.99, 3.99, 768.99, 3.99, 256.99, 1536.99, 3.99, 1536.99, 3.99, 1536.99, 3.99, 1024.99, ])
            # print(1)

    def init_pso_controller(self,):
        self.controller = PSO(func=self.schaffer, n_dim=44, pop=4, max_iter=50, lb=[1]*44, ub=[32.99, 64.99, 3.99, 32.99, 192.99, 3.99, 32.99, 192.99, 3.99, 192.99, 3.99, 192.99, 3.99, 64.99, 384.99, 3.99,
                                                                                               384.99, 3.99, 384.99, 3.99, 96.99, 576.99, 3.99, 576.99, 3.99, 576.99, 3.99, 128.99, 768.99, 3.99, 768.99, 3.99, 768.99, 3.99, 768.99, 3.99, 256.99, 1536.99, 3.99, 1536.99, 3.99, 1536.99, 3.99, 1024.99, ])
        return
